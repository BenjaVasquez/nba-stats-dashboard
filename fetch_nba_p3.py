...
TEAM_LIST = ['MIL', 'MIN', 'NOP', 'NYK', 'OKC', 'ORL', 'PHI', 'PHX']
...
def run():
    ...
    with open('data_p3.json', 'w', encoding='utf-8') as f: json.dump(data, f, indent=4, ensure_ascii=False)
